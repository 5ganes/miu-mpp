package MPP.assignment4.probleme.launch;

import MPP.assignment4.probleme.*;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Total Sum of Balance of all employees = " + Admin.computeUpdatedBalanceSum(employees));
